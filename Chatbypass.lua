--[[
	...
	-- API KEY: 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
]]

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Chat Bypasser", HidePremium = false, IntroText = "re_sistance's Chat Bypasser", SaveConfig = true})
